...
public class FractionalKnapsack {
    public static void main(String[] args) {
        ...
        Arrays.sort(items, Comparator.comparingDouble(Item::valuePurlUnitOfWeight).reversed());
        ...
        System.out.printf("Наилучшая ценность: %s\n", valueSoFar);
    }
}
...
class Item {
    ...
    public double valuePurlUnitOfWeight() {
